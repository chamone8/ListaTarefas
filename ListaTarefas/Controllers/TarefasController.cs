...
namespace ListaTarefas.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Inicio,Fim,Importancia")] Tarefas tarefas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Inicio,Fim,Importancia")] Tarefas tarefas)
        {
            if (id != tarefas.Id)
            {
                return NotFound();
